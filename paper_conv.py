...
class PaperWorld:
    ...
    def paper_to_vanilla(self):
        DirHandler.copy_dir(self.world_paper_path, self.world_vanilla_path,
                            "Paper world", "Vanilla world")
        DirHandler.copy_dir(self.world_paper_path + "_nether/DIM-1",
    ...
    def vanilla_to_paper(self):
        ...
        DirHandler.copy_dir(self.world_vanilla_path, self.world_paper_path,
                            "Vanilla world", "Paper world")
        DirHandler.copy_dir(self.world_vanilla_path + "/DIM-1",
                            self.world_paper_path + "_nether/DIM-1",
                            "Vanilla world nether", "Paper world_nether")
        DirHandler.copy_dir(self.world_vanilla_path + "/DIM1",
