...
# =============================================================================
print('# ' + '=' * 77)
print("                __  __  ___    ___ _    ___   _____         _    \n"
      "               |  \/  |/ __|  / __| |  |_ _| |_   _|__  ___| |___\n"
      "               | |\/| | (__  | (__| |__ | |    | |/ _ \/ _ \ (_-<\n"
      "               |_|  |_|\___|  \___|____|___|   |_|\___/\___/_/__/\n")
print("  Simple command line interface (CLI) tools to help development and maintenance \n"
      "                     of Minecraft mods, modpacks and servers")
print('# ' + '-' * 77)
# -----------------------------------------------------------------------------
