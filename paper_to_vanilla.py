...
class paper_to_vanilla:
    ...
    def paper_to_vanilla(self):
        ...
        dir_handler.copy_dir(self.root_path + self.world_paper_path + "_nether/DIM-1",
                             self.root_path + self.world_vanilla_path + "/DIM-1",
                             "Paper world_nether", "Vanilla world")
        dir_handler.copy_dir(self.root_path + self.world_paper_path + "_the_end/DIM1",
                             self.root_path + self.world_vanilla_path + "/DIM1",
    ...
    def vanilla_to_paper(self):
        ...
        dir_handler.copy_dir(self.root_path + self.world_vanilla_path + "/DIM-1",
                             self.root_path + self.world_paper_path + "_nether/DIM-1",
                             "Vanilla world nether", "Paper world_nether")
        dir_handler.copy_dir(self.root_path + self.world_vanilla_path + "/DIM1",
                             self.root_path + self.world_paper_path + "_the_end/DIM1",
